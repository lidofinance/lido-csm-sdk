...
export const CSM_CONTRACT_ADDRESSES: {
  ...
  [CHAINS.Mainnet]: {
    ...
    [CONTRACT_NAMES.exitPenalties]: '0x06cd61045f958A209a0f8D746e103eCc625f4193',
    [CONTRACT_NAMES.feeDistributor]: '0xD99CC66fEC647E68294C6477B40fC7E0F6F618D0',
    ...
    [CONTRACT_NAMES.stakingRouter]: '0xFdDf38947aFB03C621C71b06C9C70bce73f12999',
    [CONTRACT_NAMES.validatorsExitBusOracle]:
      '0x0De4Ea0184c2ad0BacA7183356Aea5B8d5Bf5c6e',
    [CONTRACT_NAMES.withdrawalVault]: '0xB9D7934878B5FB9610B3fE8A5e441e8fad7E293f',
  ...
  [CHAINS.Hoodi]: {
    ...
    [CONTRACT_NAMES.exitPenalties]: '0xD259b31083Be841E5C85b2D481Cfc17C14276800',
    [CONTRACT_NAMES.feeDistributor]: '0xaCd9820b0A2229a82dc1A0770307ce5522FF3582',
    ...
    [CONTRACT_NAMES.hashConsensus]: '0x54f74a10e4397dDeF85C4854d9dfcA129D72C637',
    [CONTRACT_NAMES.permissionlessGate]:
      '0x5553077102322689876A6AdFd48D75014c28acfb',
    [CONTRACT_NAMES.vettedGate]: '0x10a254E724fe2b7f305F76f3F116a3969c53845f',
    [CONTRACT_NAMES.stakingRouter]: '0xCc820558B39ee15C7C45B59390B503b83fb499A8',
    [CONTRACT_NAMES.validatorsExitBusOracle]:
      '0x8664d394C2B3278F26A1B44B967aEf99707eeAB2',
    [CONTRACT_NAMES.withdrawalVault]: '0x4473dCDDbf77679A643BdB654dbd86D67F8d32f2',
    [CONTRACT_NAMES.lidoRewardsVault]:
...
export const CSM_MODULE_ID_BY_CHAIN: { [key in SUPPORTED_CHAINS]: number } = {
  [CHAINS.Mainnet]: 3,
  [CHAINS.Hoodi]: 4,
};

export const CSM_DEPLOYMENT_BLOCK_NUMBER_BY_CHAIN: {
...
export const CSM_SUPPORTED_VERSION_BY_CONTRACT = {
  [CONTRACT_NAMES.accounting]: [2n, 2n],
  [CONTRACT_NAMES.feeDistributor]: [2n, 2n],
  [CONTRACT_NAMES.csModule]: [2n, 2n],

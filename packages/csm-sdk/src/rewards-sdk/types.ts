...
const rewardsReportV2Schema = z.object({
  ...
  operators: z.record(z.object({
    ...
    validators: z.record(z.object({
      attestation_duty: z.object({ assigned: z.number(), included: z.number() }),
      distributed_rewards: z.number(),
      performance: z.number(),
      proposal_duty: z.object({ assigned: z.number(), included: z.number() }),
...
export const isRewardsReportV1 = (report: RewardsReport): report is RewardsReportV1 => {
  return rewardsReportV1Schema.safeParse(report).success;
};

export const isRewardsReportV2 = (report: RewardsReport): report is RewardsReportV2 => {

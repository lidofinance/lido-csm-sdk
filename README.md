...
- **delayedPenalty**: General delayed penalty management (report, cancel, settle)
...
- [lidofinance/csm-satellite](https://github.com/lidofinance/csm-satellite) — Staking module discovery contracts (`SMDiscovery`)
